Shader "FLL/FLL_HatchingMat"
{
    ...
    SubShader
    {
        ...
        UsePass "FLL/FLL_ToonShading/OUTLINE"
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                else if (hatchFactor > 2.0)
                {
                    ...
                    o.hatchWeight1.x = 1 - o.hatchWeights0.z;
                }
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                ///从1中减去所有6张纹理的权重，作为纯白再渲染中的贡献度
                fixed4 whiteColor = fixed4(1, 1, 1, 1) * (1 - i.hatchWeights0.x - i.hatchWeights0.y - i.hatchWeights0.z - i.hatchWeight1.x - i.hatchWeight1.y - i.hatchWeight1.z);
